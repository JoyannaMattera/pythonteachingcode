...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.cos_bttn = Button(self, text="cos", width=9, height=3, command=lambda: self.add+chr('cos'))
        self.cos_bttn.grid(row=2, column=6)
        
        self.tan_bttn = Button(self, text="tan", width=9, height=3, command=lambda: self.add+chr('tan'))
        ...
        self.one_bttn = Button(self, text="Joyanna", width=9, height=3, command=lambda: self.add_chr("Mattera"))
